...
const Banner = () => {
    return (
        ...
        >
            ...
            <SwiperSlide>
                <section className="relative bg-cover bg-fixed bg-center bg-no-repeat md:h-[620px] h-[500px]" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(${slider2})` }}>
            ...
            <SwiperSlide>
                <section className="relative bg-cover bg-fixed bg-center bg-no-repeat md:h-[620px] h-[500px]" style={{ backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(${slider3})` }}>
